...
$sql = $conn->query("SELECT * FROM record where YEAR(activity_timestamp) >= '".$from["year"]."' AND YEAR(activity_timestamp) <= '".$to["year"]."' AND MONTH(activity_timestamp) >= '".$from["month"]."' AND MONTH(activity_timestamp) <= '".$to["month"]."' AND WEEKDAY(activity_timestamp) >= '".$from["day"]."' AND WEEKDAY(activity_timestamp) <='" .$to["day"]."' AND HOUR(activity_timestamp) >='".$from["hour"]."' AND HOUR(activity_timestamp) <='".$to["hour"]."' AND activity_type IN ('". implode( '\',\'', $selected)."')");
